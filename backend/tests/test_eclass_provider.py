...
def test_eclass_provider_searches_then_fetches_property_by_irdi() -> None:
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        assert request.url.path.endswith("/jsonapi/v2/properties/0173-1-02-AAO677-001")
        return httpx.Response(
            200,
            json={
                "irdi": "0173-1#02-AAO677#001",
                "preferredName": [{"language": "en", "label": "Position repeatability"}],
                "definition": [{"language": "en", "label": "Repeatability of positioning."}],
