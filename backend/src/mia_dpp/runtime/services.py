"""Architecture-neutral runtime dependency container.

This module owns reusable backend dependencies. Orchestrators such as LangGraph
or a future agentic controller receive the same container instead of defining
...
class ServiceContainer:
    """Reusable runtime services shared by every orchestration architecture."""
