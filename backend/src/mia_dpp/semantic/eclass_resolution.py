...
def _route_key(trace: IdtaRoutingTrace) -> tuple[str | None, tuple[str, ...], str]:
    return trace.selected_template_key, trace.selected_path, trace.terminal_reason
...
def technical_property_evidence_ids(
    ...
    wanted = ("technical_data", TECHNICAL_DATA_ARBITRARY_PROPERTY_PATH, "wildcard")
